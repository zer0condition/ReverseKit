...
void Instrumentation::SymbolInitialize() {
    SymSetOptions(SYMOPT_UNDNAME);
    SymInitialize(GetCurrentProcess(), nullptr, true);
}

std::string Instrumentation::ParseFunction(void* Address, uint64_t* Output) {
...
bool Instrumentation::SetThreadHandlingSyscall(bool value) {
    HandlingSyscall = value;
    return true;
}

bool Instrumentation::IsThreadHandlingSyscall() {
